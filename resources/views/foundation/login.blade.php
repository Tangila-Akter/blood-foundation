                            ...
                            <div class="col-md-6 order-md-1 bg-body-extra-light">
                                <div class="block-content block-content-full px-lg-5 py-md-5 py-lg-6">
                                    <div class="mb-2 text-center">
                                        ...
                                        <p class="text-uppercase fw-bold fs-sm text-muted">Foundation Login</p>
                                    </div>
                                    <form class="js-validation-signin" action="{{ route('foundation.save_login') }}"
                                        method="POST">
                                        @csrf
                                        <div class="mb-4">
                                    ...
                                    <a href="{{ route('foundation.register') }}">Are You New Here? Please Create An Account First. <b>Click Here</b></a>
                                </div>
                            </div>
