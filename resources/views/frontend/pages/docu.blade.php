    ...
    <div class="container">
        <div>
            ...
            <div class="doc_content">
                ...
                <div class="doc_gallery">
                    <div class="doc_item">
                        <img src="{{asset('frontend/assets/Image/ceo.jpeg')}}" alt="image">
                        <div class="card_text">
                            <p>Lorem, ipsum dolor sit dolor sit  Lorem</p>
                        </div>
                    </div>
                    <div class="doc_item">
                        <img src="{{asset('frontend/assets/Image/profile1.jpg')}}" alt="image">
                        <div class="card_text">
                            <p>Lorem, ipsum dolor sit dolor sit  Lorem</p>
                        </div>
                    </div>
                ...
                <div class="doc_gallery">
                    ...
                    <div class="doc_item">
                        <img src="{{asset('frontend/assets/Image/profile.jpg')}}" alt="image">
                        <div class="card_text">
                            <p>Lorem, ipsum dolor sit dolor sit  Lorem</p>
                        </div>
                    </div>
