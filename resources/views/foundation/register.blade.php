...
<head>
    ...
    <title>Foundation Login | {{ get_system_title() }}</title>
                            ...
                            <div class="col-md-6 order-md-1 bg-body-extra-light">
                                <div class="block-content block-content-full px-lg-5 py-md-5 py-lg-6">
                                    <div class="mb-2 text-center">
                                        ...
                                        <p class="text-uppercase fw-bold fs-sm text-muted">Foundation Register</p>
                                    </div>
                                    <form class="js-validation-signin" action="{{ route('foundation.save_register') }}"
                                        method="POST">
                                        @csrf
                                        <div class="mb-4">
                                            <input type="text" class="form-control form-control-alt" id="login-name"
                                                name="name" placeholder="Enter Name">
                                        </div>
                                        <div class="mb-4">
                                            <input type="text" class="form-control form-control-alt"
                                                id="login-mobile" name="mobile" placeholder="Enter Mobile">
                                        </div>
                                        <div class="mb-4">
                                            <input type="text" class="form-control form-control-alt"
                                    ...
                                    <a href="{{ route('foundation.login') }}">Already Have An Account. Please Login.
                                        <b>Click Here</b></a>
                                </div>
                            </div>
