    ...
    <div class="modal-content">
        <div class="block block-rounded block-themed block-transparent mb-0">
            <div class="block-header bg-gd-default">
                <h3 class="block-title">@lang('union.edit_title')
                </h3>
            ...
            <div class="block-content">
                ...
                <form method="POST" class="submit-form" action="{{ route('admin.unions.update', $union->id) }}">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-12 col-md-6  mb-3">
                            <label class="form-label">@lang('union.title')</label>
                            <input type="text" class="form-control" name="title"
                                value="{{ $union->title }}">
                        </div>
                        <div class="col-12 col-md-6  mb-3">
                            <label class="form-label">@lang('union.title_bn')</label>
                            <input type="text" class="form-control" name="title_bn"
                                value="{{ $union->title_bn }}">
                        </div>

                        <div class="col-12 col-md-6  mb-3">
                            <label class="form-label">@lang('union.code')</label>
