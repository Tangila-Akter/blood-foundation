...
@section('content')
  ...
  <div class="block-content block-content-full">
    <form action="{{route('admin.health.update',$data->id)}}" method="post" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div class="row">
      ...
      <div>
          ...
          <img src="{{ asset('health') }}/{{ $data->image }}" alt="" style="height:80px;" class="img-fluid">
      </div>
