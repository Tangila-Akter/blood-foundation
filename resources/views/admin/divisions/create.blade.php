    ...
    <div class="modal-content">
        <div class="block block-rounded block-themed block-transparent mb-0">
            <div class="block-header bg-gd-default">
                <h3 class="block-title">@lang('division.create_title')</h3>
            ...
            <div class="block-content">
                ...
                <form method="POST" class="submit-form" action="{{ route('admin.divisions.store') }}">
                    @csrf
                    <div class="row">
                        <div class="col-12 col-md-6  mb-3">
                            <label class="form-label">@lang('division.title')</label>
                            <input type="text" class="form-control" name="title"
                                value="{{ old('title') }}">
                        </div>
                        <div class="col-12 col-md-6  mb-3">
                            <label class="form-label">@lang('division.title_bn')</label>
