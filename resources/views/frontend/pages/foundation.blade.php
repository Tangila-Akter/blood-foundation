    ...
    <div class="container">
        <div class="foundation">
            <div class="gellary_item">
                <a href="#">
                    <img src="{{asset('frontend/assets/Image/ceo.jpeg')}}" alt="">
                </a>
            </div>
            <div class="gellary_item">
                <a href="#">
                    <img src="{{asset('frontend/assets/Image/profile.jpg')}}" alt="">
                </a>
            </div>
            <div class="gellary_item">
                <a href="#">
                    <img src="{{asset('frontend/assets/Image/hero_img.png')}}" alt="">
                </a>
            </div>
            <div class="gellary_item">
                <a href="#">
